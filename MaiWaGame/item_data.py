...
def get_items():
    ...
    items = {
        # --- ไอเทมดั้งเดิม ---
        "I001": { "name": "ยาฟื้นฟูชั้นเลว", "type": "HEAL", "value": 20, "desc": "ฟื้นฟู HP 20 หน่วย", "price": 25, "sale_locations": ["ร้านค้าเล็กๆ"] },
        "I002": { "name": "ข้าวปั้น", "type": "HEAL", "value": 10, "desc": "ฟื้นฟู HP 10 หน่วย ช่วยประทังความหิว", "price": 10, "sale_locations": ["ร้านค้าเล็กๆ"] },
        "I003": { "name": "ยาฟื้นฟูชั้นดี", "type": "HEAL", "value": 50, "desc": "ฟื้นฟู HP 50 หน่วย", "price": 60, "sale_locations": ["ตลาด", "ร้านค้าเล็กๆ"] },
        ...
        "I005": { "name": "เหล้าสาเก", "type": "BUFF_ATK", "value": 8, "desc": "เพิ่ม ATK +8 แต่ลด DEF -3 ในการต่อสู้ครั้งต่อไป", "price": 30, "sale_locations": ["ร้านค้าเล็กๆ", "ตลาด"] },
        ...
        "I011": { "name": "ยาฟื้นฟูชั้นเลิศ", "type": "HEAL", "value": 200, "desc": "ฟื้นฟู HP 200 หน่วย หรือชุบชีวิตเมื่อตาย (ใช้โดยอัตโนมัติ)", "price": 500, "sale_locations": [] }, # ไอเทมดรอป
        ...
        "I022": { "name": "ยาพิษ", "type": "UTILITY", "value": 3, "desc": "เคลือบอาวุธ ทำให้การโจมตีครั้งต่อไปติดสถานะพิษ", "price": 120, "sale_locations": ["ตลาด"] },
